...
**YOU ARE IN: `aih_conversation_viewer/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/aih_conversation_viewer/` (rig root) or other directories
...
**Your mail address:** `aih_conversation_viewer/polecats/rust`
**Your rig:** aih_conversation_viewer
**Your Witness:** `aih_conversation_viewer/witness`
...
| Ask Witness for help | `gt mail send aih_conversation_viewer/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`aih_conversation_viewer/witness`) when:
...
```bash
gt mail send aih_conversation_viewer/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
